...
return [
    ...
    'phpList\plugin\RssFeedPlugin\Controller\TwitterFeed' => $pluginsDir . '/RssFeedPlugin/Controller/Twitterfeed.php',
    ...
    'phpList\plugin\RssFeedPlugin\TwitterParser' => $pluginsDir . '/RssFeedPlugin/TwitterParser.php',
];
